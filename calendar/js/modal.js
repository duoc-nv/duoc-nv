...
function openPopup(e) {
    var popup = document.getElementById('js-popup');
    var popupLink = document.getElementById('js-popupLink');
    var popupLink2 = document.getElementById('js-popupLink2');
    popup.classList.add("is-show");
    if (e==1) {
        popupLink.classList.add("is_show");
        popupLink2.classList.remove('is_show');
    }else {
        popupLink.classList.remove('is_show');
        popupLink2.classList.add("is_show");
    }
}
/* =================================================================== */
/* JS POPUP 宿泊*/
...
$(document).ready(function() {
    $('#js-close-btn_02').click(function(event) {
        /* Act on the event */
        $('#js-popup_02').removeClass('is-show')
    });
});